...
folds = createFolds(unique$SUBJ, 4, list = TRUE, returnTrain = FALSE)

#folds = trainControl(method="repeatedcv", number=4, repeats=4)


model = train(CHI_MLU ~ Diagnosis+VISIT+(1+SUBJ|VISIT), data = data, method = "rpart", preProcess = "scale", trControl = folds)
