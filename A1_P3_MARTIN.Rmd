...
```{r}
# Creating a dataset without bernie and one with ONLY bernie (Bernie is number 63)
...
# selecting bernie data and MLU
select_bernie = full_data %>%
  filter(SUBJ == 63)%>%
  select(CHI_MLU)
...
# getting the difference between Bernie and the TD over visit in MLU
select_bernie[, 1] - MLU_list
