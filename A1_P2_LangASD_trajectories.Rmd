...
#installed.packages("MuMIn")
library(lmerTest,MuMIn,ggplot2)
library(ggplot2)
...
summary(glm(Gender~Diagnosis, family = binomial,data)) # Gender is equally distributed
summary(lm(Age~Diagnosis, data)) # ASD kids are on average older (12,67 months)
summary(lm(verbalIQ~Diagnosis,data))
