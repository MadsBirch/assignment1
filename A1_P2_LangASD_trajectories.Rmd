...
The variable Diagnosis is not significantly predicted by the variables Gender and nonverbalIQ, meaning that the groups are well balanced on these data. (beta -17, se = 0.87, t-value = -14.41, p < 0.05). (what does that really mean?)
...
When looking at verbalIQ, TD children scores significantly higher than ASD children, however, when plotting the variable, it becomes clear that ASD children are roughly divided into two groups. One group that score higher than TD children and one that scores lower. 
...
getwd()
locpath= "C:/Users/sdam9/Documents/EXP3/assignment1"
setwd(locpath)
