...
powerCurveV # 0% power at 30 particpants
...
# All in all, it only makes sense to run the study on 30 participants if we were interested in only gender and verbal IQ. Since we're interested in the effect of diagnosis, the study should't be run.
